            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Image.asset(
                    'assets/images/travel-high-resolution-logo-white-on-transparent-background.png',
                    width: 215.0,
                    height: 140.0,
                    fit: BoxFit.cover,
                  ),
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: FFLocalizations.of(context).getText(
                            'xecjhieh' /* Email Address */,
                          ),
                          labelStyle: FlutterFlowTheme.of(context).bodyMedium,
                          hintText: FFLocalizations.of(context).getText(
                            '41s2640s' /* Email Address */,
                          ),
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: FFLocalizations.of(context).getText(
                            '8v26twb8' /* Choose Password */,
                          ),
                          labelStyle: FlutterFlowTheme.of(context).bodyMedium,
                          hintText: FFLocalizations.of(context).getText(
                            'bcg9tyjd' /* Choose Password */,
                          ),
                          enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                              color: Color(0x00000000),
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: FFLocalizations.of(context).getText(
                            '7a4f6bc1' /* Confirm Password */,
                          ),
                          labelStyle: FlutterFlowTheme.of(context).bodyMedium,
                          hintText: FFLocalizations.of(context).getText(
                            'su8k0n6c' /* Confirm Password */,
                          ),
                          enabledBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                              color: Color(0x00000000),
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'vh1u92bu' /* Already have an account? */,
                          ),
