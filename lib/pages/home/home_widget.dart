                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: ListTile(
                                    ...
                                    subtitle: Text(
                                      FFLocalizations.of(context).getText(
                                        'mmrhnr4l' /* We hope you have a wonderful d... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium,
                                    ),
                                ...
                                Align(
                                  ...
                                  child: ListTile(
                                    title: Text(
                                      FFLocalizations.of(context).getText(
                                        '93ou7sys' /* Your your travel today  */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .titleLarge,
                                    ),
                                                ...
                                                children: [
                                                  Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'z9kepai7' /* Houssem eddine khoildi */,
                                                    ),
