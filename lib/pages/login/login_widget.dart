            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Image.asset(
                    'assets/images/travel-high-resolution-logo-color-on-transparent-background.png',
                    width: 300.0,
                    height: 190.0,
                    fit: BoxFit.cover,
                  ),
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: FFLocalizations.of(context).getText(
                            '0k3f0426' /* Email Address */,
                          ),
                          labelStyle: FlutterFlowTheme.of(context).bodyMedium,
                          hintText: FFLocalizations.of(context).getText(
                            'q7x3zzr3' /* Email Address */,
                          ),
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'v0cvvgc5' /* Don't have an account? */,
                          ),
                ...
                FlutterFlowLanguageSelector(
                  ...
                  dropdownIconColor: FlutterFlowTheme.of(context).dark900,
                  borderRadius: 8.0,
                  textStyle: TextStyle(
