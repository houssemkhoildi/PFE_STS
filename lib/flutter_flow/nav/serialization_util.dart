  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case ShapesRow:
            return ShapesRow(data);
          case AgencyRow:
            return AgencyRow(data);
          case StopsRow:
            return StopsRow(data);
          case CalendarDatesRow:
            return CalendarDatesRow(data);
          case StopTimesRow:
            return StopTimesRow(data);
          case CalendarRow:
            return CalendarRow(data);
          case FareRulesRow:
            return FareRulesRow(data);
          case TripsRow:
            return TripsRow(data);
          case UsersRow:
            return UsersRow(data);
          case RoutesRow:
            return RoutesRow(data);
          case FareAttributesRow:
            return FareAttributesRow(data);
          case StsRow:
            return StsRow(data);
          case AdminRow:
