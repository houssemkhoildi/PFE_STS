...
import 'ajutestation_model.dart';
export 'ajutestation_model.dart';

class AjutestationWidget extends StatefulWidget {
  const AjutestationWidget({Key? key}) : super(key: key);

  @override
  _AjutestationWidgetState createState() => _AjutestationWidgetState();
}

class _AjutestationWidgetState extends State<AjutestationWidget> {
  late AjutestationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AjutestationModel());
                                    ...
                                    await showDialog<bool>(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              ...
                                              content: Text(
                                                  'Hello  , we are excited to add a new station to our mobile app! '),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
